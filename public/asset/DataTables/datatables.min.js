 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/b-1.6.1/b-flash-1.6.1/b-print-1.6.1/r-2.2.3/sc-2.0.1/sp-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.20, Buttons 1.6.1, Flash export 1.6.1, Print view 1.6.1, Responsive 2.2.3, Scroller 2.0.1, SearchPanes 1.0.1
 */
...
(function(f) {
    ...
    q.ext = C = {
        buttons: {},
        classes: {},
        build: "bs4/dt-1.10.20/b-1.6.1/b-flash-1.6.1/b-print-1.6.1/r-2.2.3/sc-2.0.1/sp-1.0.1",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
...
$jscomp.checkEs6ConformanceViaProxy = function() {
    try {
        var b = {},
            m = Object.create(new $jscomp.global.Proxy(b, {
                get: function(k, h, f) {
                    return k == b && "q" == h && f == m
                }
            }));
...
$jscomp.polyfill = function(b, m, k, h) {
    if (m) {
        ...
        h = k[b];
        m = m(h);
        m != h && null != m && $jscomp.defineProperty(k, b, {
            configurable: !0,
            writable: !0,
            value: m
        })
    ...
    function m() {
        ...
        try {
            var a = Object.seal({
                ...
                e = new b($jscomp.makeIterator([
                    [a, "s"]
                ]));
            if ("s" != e.get(a) || 1 != e.size || e.get({
                    x: 4
                }) || e.set({
                    x: 4
    ...
    var b = $.fn.dataTable,
        m = function() {
            ...
            f.prototype.getPaneCount = function() {
                return void 0 !==
                    this.s.dtPane ? this.s.dtPane.rows({
                        selected: !0
            ...
            f.prototype._addOption = function(a, d, g, c, e, r) {
                if (Array.isArray(a) || a instanceof b.Api)
                    if (a instanceof b.Api && (a = a.toArray(), d = d.toArray()), a.length === d.length)
                        for (var f = 0; f < a.length; f++) r[a[f]] ? r[a[f]]++ : (r[a[f]] = 1, e.push({
                            display: d[f],
                            filter: a[f],
                            sort: g,
                            type: c
                ...
                else "string" === typeof this.s.colOpts.orthogonal ? r[a] ? r[a]++ : (r[a] = 1, e.push({
                    display: d,
                    filter: a,
                    sort: g,
                    type: c
            ...
            f.prototype._addRow = function(a, d, g, c, e, f) {
                ...
                void 0 === r && (r = this.s.indexes.length, this.s.indexes.push({
                    filter: d,
                    index: r
                }));
            ...
            f.prototype._buildPane = function() {
                ...
                if (this.colExists) {
                    ...
                    if (0 === e.arrayFilter.length)
                        if (this._populatePane(), l && l.searchPanes && l.searchPanes.panes)
                            if (-1 !== q) e.binsOriginal = l.searchPanes.panes[q].bins, e.arrayOriginal = l.searchPanes.panes[q].arrayFilter;
                            else {
                ...
                this.s.dtPane = $(this.dom.dtP).DataTable($.extend(!0, {
                    ...
                    columnDefs: [{
                        ...
                        targets: 0,
                        type: void 0 !== d.settings()[0].aoColumns[this.s.index] ?
                ...
                if (l && l.searchPanes && l.searchPanes.panes)
                    for (this.c.cascadePanes || this._reloadSelect(l), g = 0, l = l.searchPanes.panes; g < l.length; g++) p = l[g], p.id === this.s.index && ($(this.dom.searchBox).val(p.searchTerm), this.s.dt.order(p.order));
                ...
                this.s.dtPane.on("deselect.dtsp", function() {
                    h = setTimeout(function() {
                        ...
                        0 === a.s.dtPane.rows({
                            selected: !0
                        }).data().toArray().length && $(a.dom.clear).addClass(a.classes.dull);
                        a._makeSelection();
                        a.s.deselect = !1;
                        a.s.dt.state.save()
                    }, 50)
            ...
            f.prototype._findUnique = function(a,
                ...
                for (var g = [], c = 0; c < d.length; c++) {
                    var e = d[c]; - 1 === g.indexOf(e.filter) && (a.push({
                        display: e.display,
                        filter: e.filter,
                        sort: e.sort,
                        type: e.type
            ...
            f.prototype._populatePane = function() {
                ...
                var d = this.s.dt.settings()[0],
                    g = 0;
                for (a = !this.c.cascadePanes && !this.c.viewTotal || this.s.clearing ? a.rows().indexes() : a.rows({
                        search: "applied"
                    }).indexes(); g < a.length; g++) this._populatePaneArray(a[g], this.s.rowData.arrayFilter, d)
            };
                ...
                if (void 0 !== a) {
                    ...
                    if (void 0 !==
                        ...
                        for (a = a.searchPanes.panes[d].selected; e < a.length; e++) {
                            d = a[e];
                            var b = -1;
                            null !== d && (b = c.indexOf(d.toString())); - 1 < b && (g.row(b).select(), this.s.dt.state.save())
                        }
                    }
                }
            };
            ...
            f.prototype._searchExtras = function() {
                ...
                this.s.updating = !0;
                var d = this.s.dtPane.rows({
                        selected: !0
                    }).data().pluck("filter").toArray(),
                    g = d.indexOf(this.c.emptyMessage),
                    c = $(this.s.dtPane.table().container()); - 1 < g && (d[g] = "");
                ...
                if (!(void 0 === this.s.dtPane || this.s.filteringActive && !this.c.cascadePanes && !0 !== a || !0 === this.c.cascadePanes && !0 === this.s.selectPresent || this.s.lastSelect)) {
                    ...
                    if (this.colExists) {
                        0 === c.arrayFilter.length ? this._populatePane() : this.c.cascadePanes && this.s.dt.rows().data().toArray().length ===
                            this.s.dt.rows({
                                search: "applied"
                            }).data().toArray().length ? (c.arrayFilter = c.arrayOriginal, c.bins = c.binsOriginal) : (this.c.viewTotal || this.c.cascadePanes) && this._populatePane();
                    ...
                    if (void 0 !== d.searchPanes && void 0 !== d.searchPanes.options || void 0 !== d.options || null !== this.customPaneSettings && void 0 !== this.customPaneSettings.options)
                        for (e = function(a) {
        ...
        h = function() {
            function b(a, d, g) {
                ...
                this._getState();
                if (this.s.dt.settings()[0]._bInitComplete || g) this._paneDeclare(e, a, d);
                else e.on("preInit.dt",
                    function() {
            ...
            b.prototype.redrawPanes = function() {
                ...
                if (!this.s.updating) {
                    ...
                    if (a.rows({
                            search: "applied"
                        }).data().toArray().length === a.rows().data().toArray().length) d = !1;
                    else if (this.c.viewTotal)
                        for (var c = 0, e = this.s.panes; c < e.length; c++) {
                            var f = e[c];
                            if (void 0 !== f.s.dtPane) {
                                var n = f.s.dtPane.rows({
                                    selected: !0
                                }).data().toArray().length;
                    ...
                    if (this.regenerating) {
                        ...
                        for (var l = this.s.panes; n < l.length; n++)
                            ...
                            e =
                                f.s.index;
                            var h = f.s.dtPane.rows({
                                selected: !0
                            }).data().toArray();
                            0 < h.length && this.s.selectionList.push({
                                index: f.s.index,
                                rows: h,
                                protect: !0
                            })
                        ...
                        if (0 < this.s.selectionList.length)
                            for (a = this.s.selectionList[this.s.selectionList.length - 1].index, n = 0, l = this.s.panes; n < l.length; n++) f = l[n], f.s.lastSelect = f.s.index === a && 1 === this.s.selectionList.length;
                        for (f = 0; f < this.s.selectionList.length; f++)
                            if (this.s.selectionList[f].index !== e || !0 === this.s.selectionList[f].protect) {
                                a = !1;
                        ...
                        if (0 < c.length && c.length < this.s.selectionList.length)
                            for (this._cascadeRegen(c), a = c[c.length - 1].index, b = 0, c = this.s.panes; b < c.length; b++) f = c[b], f.s.lastSelect = f.s.index === a && 1 === this.s.selectionList.length;
                        else if (0 < c.length)
            ...
            b.prototype._attachMessage = function() {
                ...
                if (null === a) $(this.dom.container).addClass(this.classes.hide), $(this.dom.titleRow).removeClass(this.classes.hide);
                else return $(this.dom.container).removeClass(this.classes.hide), $(this.dom.titleRow).addClass(this.classes.hide), $(this.dom.emptyMessage).text(a),
                    ...
                    for (var b =
                            a[d], c = function(a) {
                                if (a.s.index === b.index && void 0 !== a.s.dtPane) {
                                    0 < a.s.dtPane.rows({
                                        selected: !0
                                    }).data().toArray().length && void 0 !== a.s.dtPane && (a.setClear(!0), a.clearPane(), a.setClear(!1));
            ...
            b.prototype._startup = function(a) {
                ...
                a.columns(0 < this.c.columns.length ? this.c.columns : void 0).eq(0).each(function(a) {
                    if (void 0 !== d.s.panes[a] && void 0 !== d.s.panes[a].s.dtPane && void 0 !== d.s.panes[a].s.colOpts.preSelect)
                        for (var c = d.s.panes[a].s.dtPane.rows().data().toArray().length, b = 0; b < c; b++) - 1 !== d.s.panes[a].s.colOpts.preSelect.indexOf(d.s.panes[a].s.dtPane.cell(b, 0).data()) &&
            ...
            init: function(a, c, d) {
                var e = new b.fn.dataTable.SearchPanes(a, {
                        filterChanged: function(b) {
                            a.button(c).text(a.i18n("searchPanes.collapse", {
                                0: "SearchPanes",
                                _: "SearchPanes (%d)"
                            }, b))
                        }
